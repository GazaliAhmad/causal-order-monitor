...
- discriminated JSON-safe operator snapshot schema version 1 with a compatibility-preserving unversioned projection
- stable overall status, affected components, recommended actions, backlog age, replay progress, admission posture, and filesystem storage-pressure evidence
- explicit accepted-live, accepted-buffered (`202`), and protective-refusal (`503`) semantics
